...
P85 retains 92 public components and advances to version 1.80.1. UiAvatar provides grapheme-safe initials, image fallback/retry, accessible labels, scoped placeholder slots and SSR-safe inspection. Release gates include dedicated unit/SSR/type, visual/Axe/three-browser, static preview and packed consumer coverage.
