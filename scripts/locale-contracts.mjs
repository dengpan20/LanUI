...
const localized=new Set([
  'UiAlert','UiAnchor','UiAutoComplete','UiBadge','UiBreadcrumb','UiCalendar','UiCascader','UiColorPicker','UiCommandPalette','UiCronEditor','UiDatePicker','UiDateRangePicker','UiDescriptions','UiDrawer','UiEmpty','UiFormItem','UiImage','UiInput','UiKeyValueEditor','UiList','UiListToolbar','UiMenu','UiMentions','UiModal','UiMultiSelect','UiNotification','UiNumberInput','UiOtpInput','UiPagination','UiPopconfirm','UiPopover','UiProgress','UiRate','UiSelect','UiSlider','UiSpin','UiStatistic','UiSteps','UiSwitch','UiTable','UiTabs','UiToastHost','UiTour','UiTransfer','UiTree','UiTreeSelect','UiTypography','UiUpload',
])
