...
const localized=new Set([
  'UiAlert','UiAutoComplete','UiBadge','UiBreadcrumb','UiCascader','UiColorPicker','UiCommandPalette','UiDatePicker','UiDateRangePicker','UiDescriptions','UiDrawer','UiEmpty','UiFormItem','UiInput','UiListToolbar','UiMenu','UiModal','UiMultiSelect','UiNotification','UiNumberInput','UiPagination','UiPopconfirm','UiPopover','UiProgress','UiRate','UiSelect','UiSlider','UiSpin','UiSteps','UiSwitch','UiTable','UiTabs','UiToastHost','UiTransfer','UiTree','UiTreeSelect','UiUpload',
])
