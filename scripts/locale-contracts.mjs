...
const localized=new Set([
  'UiAlert','UiAutoComplete','UiBadge','UiBreadcrumb','UiCascader','UiDatePicker','UiDateRangePicker','UiDescriptions','UiDrawer','UiEmpty','UiFormItem','UiInput','UiListToolbar','UiMenu','UiModal','UiMultiSelect','UiNotification','UiNumberInput','UiPagination','UiPopconfirm','UiPopover','UiProgress','UiSelect','UiSlider','UiSpin','UiSteps','UiSwitch','UiTable','UiTabs','UiToastHost','UiTransfer','UiTreeSelect','UiUpload',
])
...
for(const key of ['autocomplete.placeholder','autocomplete.clear','autocomplete.loading','autocomplete.empty','autocomplete.error','autocomplete.suggestions','input.showPassword','input.hidePassword','number.increase','number.decrease','slider.value','slider.start','slider.end','slider.setValue','table.expand','table.collapse','tree.expand','tree.collapse','toast.title.success','toast.title.info','toast.title.warning','toast.title.error'])if(!keys.includes(key))throw new Error(`Missing dynamic locale key: ${key}`)
