...
if any(marker not in preview for marker in ["V1.65.0", "previewMotionSwitch", "data-ui-motion-preference"]):
...
if package.get("version") != "1.65.0" or package.get("private") is not False or package.get("license") != "MIT":
...
if distribution_budgets != {"packedFiles": 402, "packedTarballRaw": 528000, "packedUnpackedRaw": 3050000}:
    failures.append("p39:distribution-budgets")
if "Input P69" not in components_page or "1.65.0" not in components_page or "V1.65.0" not in preview:
...
if "V1.65.0" not in app or "V1.65.0" not in login_page or "badge:89" not in components_page or "<td>Watermark</td>" not in components_page:
...
if accessibility_script.count("{name:") < 60:
...
if interaction_script.count("name: '") + interaction_script.count("name:'") < 64:
...
if performance_budgets.get("releaseBaseline", {}).get("enhancementAllowance", {}) != {'packageJsRaw': 70700, 'packageJsGzip': 23650, 'packageCssRaw': 80200, 'packageCssGzip': 14800, 'rootCssRaw': 31750, 'rootCssGzip': 4650, 'subpathConsumerJsRaw': 6500, 'subpathConsumerCssRaw': 1600, 'standaloneExampleJsRaw': 89100, 'standaloneExampleCssRaw': 32350}:
