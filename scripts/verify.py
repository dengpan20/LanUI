...
if package.get("version") != "1.72.0" or package.get("private") is not False or package.get("license") != "MIT":
...
for marker in ["v1.72.0", "91 个组件、1,518 个 Props、511 个 Events 和 321 个 Slots", "P76 成熟穿梭框组件", "raw.githubusercontent.com/dengpan20/LanUI/main/docs/images/dashboard.jpg", "docs/USAGE-GUIDE.md"]:
...
if len(visual_baselines) < 49 or any(path.stat().st_size < 1000 for path in visual_baselines):
...
if interaction_script.count("name: '") + interaction_script.count("name:'") < 71:
...
if performance_budgets.get("releaseBaseline", {}).get("enhancementAllowance", {}) != {'packageJsRaw': 187000, 'packageJsGzip': 59000, 'packageCssRaw': 202000, 'packageCssGzip': 35000, 'rootCssRaw': 68000, 'rootCssGzip': 9500, 'largestComponentCssRaw': 1000, 'largestComponentCssGzip': 1000, 'subpathConsumerJsRaw': 10000, 'subpathConsumerCssRaw': 2100, 'standaloneExampleJsRaw': 242000, 'standaloneExampleCssRaw': 69000}:
