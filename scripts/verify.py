...
if any(marker not in preview for marker in ["V1.62.0", "previewMotionSwitch", "data-ui-motion-preference"]):
...
if package.get("version") != "1.62.0" or package.get("private") is not False or package.get("license") != "MIT":
...
if distribution_budgets != {"packedFiles": 402, "packedTarballRaw": 510000, "packedUnpackedRaw": 2935000}:
    failures.append("p39:distribution-budgets")
if "Dropdown P66" not in components_page or "1.62.0" not in components_page or "V1.62.0" not in preview:
...
if "V1.62.0" not in app or "V1.62.0" not in login_page or "badge:89" not in components_page or "<td>Watermark</td>" not in components_page:
...
if len(visual_baselines) < 39 or any(path.stat().st_size < 1000 for path in visual_baselines):
...
if accessibility_script.count("{name:") < 57:
...
if interaction_script.count("name: '") + interaction_script.count("name:'") < 61:
...
if performance_budgets.get("releaseBaseline", {}).get("enhancementAllowance", {}) != {"packageJsRaw": 50600, "packageJsGzip": 16700, "packageCssRaw": 57450, "packageCssGzip": 10350, "rootCssRaw": 26100, "rootCssGzip": 3800, "subpathConsumerCssRaw": 100, "standaloneExampleJsRaw": 62400, "standaloneExampleCssRaw": 26700, "subpathConsumerJsRaw": 300}:
    failures.append("performance:p66-bounded-component-enhancement-policy")
