...
if package.get("version") != "1.73.0" or package.get("private") is not False or package.get("license") != "MIT":
...
if distribution_budgets != {"packedFiles": 412, "packedTarballRaw": 590000, "packedUnpackedRaw": 3610000}:
...
for marker in ["v1.73.0", "91 个组件、1,540 个 Props、518 个 Events 和 330 个 Slots", "P77 成熟分页组件", "raw.githubusercontent.com/dengpan20/LanUI/main/docs/images/dashboard.jpg", "docs/USAGE-GUIDE.md"]:
...
if len(visual_baselines) < 50 or any(path.stat().st_size < 1000 for path in visual_baselines):
...
if performance_budgets.get("releaseBaseline", {}).get("enhancementAllowance", {}) != {'packageJsRaw': 205000, 'packageJsGzip': 64000, 'packageCssRaw': 235000, 'packageCssGzip': 40000, 'rootCssRaw': 78000, 'rootCssGzip': 10500, 'largestComponentCssRaw': 1000, 'largestComponentCssGzip': 1000, 'subpathConsumerJsRaw': 10000, 'subpathConsumerCssRaw': 2100, 'standaloneExampleJsRaw': 260000, 'standaloneExampleCssRaw': 78000}:
