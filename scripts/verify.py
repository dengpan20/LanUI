...
if package.get("version") != "1.74.0" or package.get("private") is not False or package.get("license") != "MIT":
...
if distribution_budgets != {"packedFiles": 412, "packedTarballRaw": 610000, "packedUnpackedRaw": 3720000}:
...
for marker in ["v1.74.0", "91 个组件、1,594 个 Props、546 个 Events 和 339 个 Slots", "P78 成熟表格组件", "raw.githubusercontent.com/dengpan20/LanUI/main/docs/images/dashboard.jpg", "docs/USAGE-GUIDE.md"]:
...
if performance_budgets.get("releaseBaseline", {}).get("enhancementAllowance", {}) != {'packageJsRaw': 223000, 'packageJsGzip': 69000, 'packageCssRaw': 236000, 'packageCssGzip': 40000, 'rootCssRaw': 78000, 'rootCssGzip': 10500, 'largestComponentCssRaw': 1000, 'largestComponentCssGzip': 1000, 'subpathConsumerJsRaw': 10000, 'subpathConsumerCssRaw': 2100, 'standaloneExampleJsRaw': 278000, 'standaloneExampleCssRaw': 78000}:
    failures.append("performance:p77-bounded-component-enhancement-policy")
