...
const allCases=[
  ...
  {name:'pagination-contract',viewport:{width:1280,height:900},query:'theme=dark&direction=rtl&density=compact&state=pagination',ready:'.visual-pagination-showcase [data-pagination-state-contract]',selector:'.visual-pagination-showcase',prepare:async page=>{await page.locator('.visual-pagination-showcase').evaluate(element=>element.scrollIntoView({block:'center'}));await page.waitForTimeout(120)},diffAllowance:.002},
  {name:'table-contract',viewport:{width:1280,height:920},query:'theme=dark&direction=rtl&density=compact&state=table',ready:'.visual-table-showcase [data-table-state-contract]',selector:'.visual-table-showcase',prepare:async page=>{await page.locator('.visual-table-showcase').evaluate(element=>element.scrollIntoView({block:'center'}));await page.waitForTimeout(120)},diffAllowance:.002},
  ...
  {name:'skeleton-contract',viewport:{width:1280,height:900},query:'theme=dark&direction=rtl&density=compact&state=skeleton',ready:'.visual-skeleton-showcase [data-skeleton-state-contract]',selector:'.visual-skeleton-showcase',prepare:async page=>{await page.locator('.visual-skeleton-showcase').evaluate(element=>element.scrollIntoView({block:'center'}));await page.waitForTimeout(120)},diffAllowance:.002},
  {name:'avatar-contract',viewport:{width:1280,height:900},query:'theme=dark&direction=rtl&density=compact&state=avatar',ready:'.visual-avatar-showcase [data-avatar-state-contract]',selector:'.visual-avatar-showcase',prepare:async page=>{await page.locator('.visual-avatar-showcase').evaluate(element=>element.scrollIntoView({block:'center'}));await page.waitForTimeout(120)},diffAllowance:.002},
