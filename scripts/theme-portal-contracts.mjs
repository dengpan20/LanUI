...
if(records.length!==12||teleportCount!==12)failures.push(`expected 12 current Teleport components, received components=${records.length} teleports=${teleportCount}`)
