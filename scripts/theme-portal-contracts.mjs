...
if(records.length!==14||teleportCount!==14)failures.push(`expected 14 current Teleport components, received components=${records.length} teleports=${teleportCount}`)
