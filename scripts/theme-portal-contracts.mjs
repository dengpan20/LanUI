...
if(records.length!==13||teleportCount!==13)failures.push(`expected 13 current Teleport components, received components=${records.length} teleports=${teleportCount}`)
