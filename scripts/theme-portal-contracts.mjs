...
if(records.length!==17||teleportCount!==17)failures.push(`expected 17 current Teleport components, received components=${records.length} teleports=${teleportCount}`)
