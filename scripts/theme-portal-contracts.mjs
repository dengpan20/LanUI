...
if(records.length!==18||teleportCount!==18)failures.push(`expected 18 current Teleport components, received components=${records.length} teleports=${teleportCount}`)
