...
if(componentFiles.length!==manifest.components.length||componentFiles.length!==70)throw new Error(`Component stylesheet count mismatch: ${componentFiles.length}`)
