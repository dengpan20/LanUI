...
if(componentFiles.length!==manifest.components.length||componentFiles.length!==78)throw new Error(`Component stylesheet count mismatch: ${componentFiles.length}`)
