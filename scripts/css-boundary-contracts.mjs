...
if(componentFiles.length!==manifest.components.length||componentFiles.length!==75)throw new Error(`Component stylesheet count mismatch: ${componentFiles.length}`)
