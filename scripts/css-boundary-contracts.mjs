...
if(componentFiles.length!==manifest.components.length||componentFiles.length!==92)throw new Error(`Component stylesheet count mismatch: ${componentFiles.length}`)
