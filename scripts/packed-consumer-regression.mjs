...
},include:['contracts.ts','carousel-contracts.ts','time-range-contracts.ts','date-time-contracts.ts']},null,2)+'\n')
...
assert(componentNames.length===84,'Public component count mismatch')
