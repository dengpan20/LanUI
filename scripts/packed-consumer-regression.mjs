...
assert(ssrOutput.includes('PACKED_SSR PASS'),'Packed SSR smoke test failed')
  ...
  writeFileSync(join(consumerRoot,'contracts.ts'),`import { UiAffix, UiAnchor, UiList, UiMentions, UiSplitter, UiTypography, type UiAffixMeta, type UiAffixProps, type UiAnchorItem, type UiAnchorProps, type UiListProps, type UiMentionsProps, type UiSplitterPanel, type UiSplitterProps, type UiTypographyProps, type UiTourStep, type UiWatermarkFont } from 'lan-ui-design-system'\nimport SubpathAffix from 'lan-ui-design-system/components/UiAffix'\nimport UiButton, { type UiButtonProps } from 'lan-ui-design-system/components/UiButton'
...
assert(componentNames.length===78,'Public component count mismatch')
