...
const cases=[
  ...
  {name:'skeleton-contract',viewport:{width:1280,height:900},query:'theme=dark&direction=rtl&density=compact&state=skeleton',ready:'.visual-skeleton-showcase [data-skeleton-state-contract]',prepare:async page=>{await page.locator('.visual-skeleton-showcase').scrollIntoViewIfNeeded()}},
  {name:'avatar-contract',viewport:{width:1280,height:900},query:'theme=dark&direction=rtl&density=compact&state=avatar',ready:'.visual-avatar-showcase [data-avatar-state-contract]',prepare:async page=>{await page.locator('.visual-avatar-showcase').scrollIntoViewIfNeeded()}},
