...
<template>
  <div class="page-container"><UiPageHeader title="甘特计划" description="可视化跟踪任务周期、负责人和项目进度" :breadcrumbs="[{label:'项目管理',href:'#/gantt'},{label:'甘特计划'}]"><template #actions><UiButton variant="outline" icon="download" @click="$emit('notify','甘特图已导出')">导出</UiButton><UiButton icon="plus" @click="$emit('open-modal','新建任务')">新建任务</UiButton></template></UiPageHeader>
