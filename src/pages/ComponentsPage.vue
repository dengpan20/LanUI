...
const descriptionItems=[{key:'name',label:'当前成熟度',value:'Upload Orchestration P32'},{key:'version',label:'当前版本',value:'1.28.0'},{key:'status',label:'状态',value:'稳定'},{key:'owner',label:'维护团队',value:'基础组件组'},{key:'updated',label:'最近更新',value:'2026-08-13'},{key:'coverage',label:'用例覆盖',value:'受控队列、异步请求、并发、进度、取消、重试、前置校验、移除守卫、SSR、RTL、ARIA'}]
