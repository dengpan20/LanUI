...
const descriptionItems=[{key:'name',label:'当前成熟度',value:'Packed Distribution P39'},{key:'version',label:'当前版本',value:'1.35.0'},{key:'status',label:'状态',value:'稳定'},{key:'owner',label:'维护团队',value:'基础组件组'},{key:'updated',label:'最近更新',value:'2026-08-13'},{key:'coverage',label:'用例覆盖',value:'70 组件、698 Props、242 Events、116 Slots、自动 API 文档、主题与动效、SSR、RTL、ARIA、三浏览器、性能预算与真实 tarball 安装'}]
