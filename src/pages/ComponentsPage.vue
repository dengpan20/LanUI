...
const descriptionItems=[{key:'name',label:'本轮能力',value:'Layout primitives P83 · FloatButton P82 · DateRangePicker P81 · Cascader P75 · TreeSelect P74 · MultiSelect P73 · Select P72 · Selection Controls P71 · Textarea P70 · Input P69 · Button P68 · Collapse P67 · Dropdown P66 · Popover P65 · Tooltip P64 · Breadcrumb P63 · Steps P62 · Timeline P61 · Tag P60 · Card P59'},{key:'version',label:'版本',value:'1.78.0'},{key:'status',label:'状态',value:'稳定'},{key:'owner',label:'负责团队',value:'设计系统组'},{key:'updated',label:'更新日期',value:'2026-08-25'},{key:'coverage',label:'覆盖范围',value:'92 个公开组件 · UiLayout / UiGrid / UiCol / UiSpace / UiDivider 提供响应式断点、实际列偏移、auto-fit/auto-fill、Fragment 分隔符、语义 Divider、SSR 安全实例、RTL、暗色、紧凑密度、视觉、Axe、三浏览器、静态预览与隔离 tarball 消费回归'}]
const layoutDemoColumns=ref(12);const layoutDemoMode=ref('fixed');const layoutDemoDirection=ref('horizontal');const layoutDemoDensity=ref('default');const layoutDemoRtl=ref(false)
