...
const multiDemo=ref(['east']);const multiRemoteDemo=ref([]);const multiState=ref('等待选择');const treeDemo=ref(['hangzhou']);const treeRemoteDemo=ref('');const treeState=ref('等待树选择');const cascaderDemo=ref(['zhejiang','hangzhou','xihu']);const cascaderMultiDemo=ref([['zhejiang','hangzhou','binjiang']]);const cascaderRemoteDemo=ref([]);const cascaderState=ref('等待层级选择');const transferDemo=ref(['api'])
...
const transferOptions=[{label:'组件 API',value:'api'},{label:'交互规范',value:'interaction'},{label:'无障碍规范',value:'a11y'},{label:'视觉 Token',value:'token'},{label:'业务模板',value:'template'}]
