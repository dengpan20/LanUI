...
<template>
<div class="auth-page"><section class="auth-visual"><div class="auth-brand"><span class="brand-mark"><AppIcon name="layers"/></span>Lan UI <span class="brand-version">V1.43.0</span></div><div class="auth-message"><div class="auth-kicker">Clean Enterprise Design System</div><h1>让复杂业务，拥有清晰秩序。</h1><p>基于统一 Token、组件与交互模式构建的企业级后台系统，兼顾信息密度、效率与一致性。</p><div class="auth-features"><span class="auth-feature"><AppIcon name="checkCircle"/>Vue 3 组件化</span><span class="auth-feature"><AppIcon name="checkCircle"/>完整交互状态</span><span class="auth-feature"><AppIcon name="checkCircle"/>响应式与暗色模式</span></div></div><div class="auth-grid-art"/><div class="auth-footer">© 2026 Lan UI · Design System Showcase</div></section>
