...
export interface LanUiConfig { locale:LanUiLocale; fallbackLocale?:LanUiLocale|null; fallbackLocales:LanUiLocale[]; localeRegistry:LocaleRegistry; size:ComponentSize; density:'compact'|'default'|'comfortable'; direction:Direction; zIndex:number; appearance:ThemeAppearance; themeName:string; theme:ThemeTokens }
export interface LanUiConfigOptions { locale?:LocaleInput; fallbackLocale?:LocaleFallback; fallbackLocales?:LocaleInput[]; localeRegistry?:LocaleRegistry; size?:ComponentSize; density?:LanUiConfig['density']; direction?:Direction; zIndex?:number; appearance?:ThemeAppearance; theme?:ThemeInput }
