...
export type UiSchemaFormBuiltinType = 'input'|'input-tag'|'query-builder'|'textarea'|'number'|'select'|'autocomplete'|'checkbox'|'switch'|'date'|'time'|'date-range'|'slider'|'segmented'|'list'
