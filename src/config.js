...
export const enUS={
  ...
  messages:{
    ...
    'virtualList.label':'Virtual list','virtualList.empty':'No list data','virtualList.loading':'Loading list','virtualList.errorTitle':'List failed to load','virtualList.error':'Try again shortly','virtualList.selectedCount':'{count} selected',
