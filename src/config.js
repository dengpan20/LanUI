...
export const enUS={
  ...
  messages:{
    ...
    'input.clear':'Clear input','input.showPassword':'Show password','input.hidePassword':'Hide password','number.increase':'Increase value','number.decrease':'Decrease value','slider.value':'Slider value','slider.start':'Range start','slider.end':'Range end','slider.setValue':'Set value to {value}','rate.label':'Rating','rate.value':'{value} of {max}','rate.unrated':'Not rated','rate.clear':'Clear rating','rate.keyboardHint':'Use Arrow keys to adjust, Home or End to jump, and Delete to clear','statistic.label':'Statistic','statistic.empty':'—','statistic.loading':'Loading statistic','statistic.trend.up':'Up','statistic.trend.down':'Down','statistic.trend.flat':'No change',
