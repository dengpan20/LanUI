...
export const enUS={
  ...
  messages:{
    ...
    'upload.region':'File upload','upload.input':'Choose files','upload.hint':'Click or drag files here','upload.dragging':'Release to upload','upload.limit':'Up to {size}MB each, {count} files maximum','upload.maxCount':'Upload up to {count} files','upload.typeInvalid':'{name} has an unsupported file type','upload.sizeInvalid':'{name} exceeds {size}MB','upload.beforeRejected':'{name} did not pass the pre-upload check','upload.list':'Upload file list','upload.remove':'Remove {name}','upload.start':'Upload {name}','upload.abort':'Cancel upload for {name}','upload.retry':'Retry upload for {name}','upload.progress':'Upload progress for {name}','upload.status.ready':'Ready','upload.status.uploading':'Uploading','upload.status.success':'Uploaded','upload.status.error':'Upload failed','upload.status.canceled':'Canceled',
