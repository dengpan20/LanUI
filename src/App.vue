...
<template>
  ...
  <div v-else class="app-shell" :class="shellClass">
    ...
    <aside class="sidebar">
      <div class="sidebar-logo"><span class="brand-mark"><AppIcon name="layers"/></span><span class="brand-name">Lan UI <small class="brand-version">V1.71.0</small></span></div>
